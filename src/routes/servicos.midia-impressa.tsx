...
import { Plus, Book, Layers, FileText } from "lucide-react";
    ...
    <div ref={revealRef} className="bg-background pt-32 pb-32">
        ...
        <div className="site-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border border border-border">
             {[
               ...
               { title: "Finalização & Fechamento", icon: <Layers size={24} /> }
             ].map((item, i) => (
               <div key={i} className="bg-background p-12 space-y-6 group hover:bg-foreground hover:text-background transition-all duration-500 rounded-sm">
                  <div className="w-12 h-12 border border-border flex items-center justify-center mb-4 group-hover:border-background/20 transition-colors rounded-md">
                     {item.icon}
                  </div>
        ...
        <div className="site-container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
             <div className="lg:col-span-6">
                <Link to="/marco-boni" className="block shadow-2xl overflow-hidden group rounded-xl">
                   <img 
             ...
             <div className="lg:col-span-6">
                ...
                <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tighter leading-[0.95] mb-8">Marco Boni: O Desafio dos 1000 Produtos</h2>
      ...
      <section className="py-32 bg-foreground text-background">
        <div className="site-container text-center">
          <h2 className="text-4xl md:text-6xl font-bold uppercase tracking-tighter leading-[0.95] mb-12">O material que sua marca merece.</h2>
